...
function Friends() {
  ...
  const people = [
    { id: 1, name: "Sarah Johnson", title: "UI/UX Designer", avatar: "https://i.pravatar.cc/150?img=20", mutualFriends: 12 },
    { id: 2, name: "Alex Chen", title: "Full Stack Developer", avatar: "https://i.pravatar.cc/150?img=21", mutualFriends: 8 },
    { id: 3, name: "Emma Davis", title: "Product Manager", avatar: "https://i.pravatar.cc/150?img=22", mutualFriends: 15 },
    { id: 4, name: "Michael Brown", title: "Marketing Specialist", avatar: "https://i.pravatar.cc/150?img=23", mutualFriends: 5 },
    { id: 5, name: "Lisa Wang", title: "Data Scientist", avatar: "https://i.pravatar.cc/150?img=24", mutualFriends: 11 },
    { id: 6, name: "James Wilson", title: "Entrepreneur", avatar: "https://i.pravatar.cc/150?img=25", mutualFriends: 20 },
    { id: 7, name: "Nina Rodriguez", title: "Content Creator", avatar: "https://i.pravatar.cc/150?img=26", mutualFriends: 7 },
    { id: 8, name: "David Lee", title: "Graphic Designer", avatar: "https://i.pravatar.cc/150?img=27", mutualFriends: 9 },
  ];
                ...
                <Box sx={{ display: "flex", gap: 1, justifyContent: "center", mt: 2 }}>
                  <Button
                    ...
                    onClick={(event) => {
                      ...
                      toggleFriend(person.id);
                      navigate(
                        toExperience("friend", {
                          title: `${person.name} Connection`,
                          context: String(person.id),
                        }),
                      );
                    }}
